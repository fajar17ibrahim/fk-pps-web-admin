									...
									<table id="table-attendance" class="table table-striped table-borderless " style="width:100%">
										...
										<tbody>
											<tr>
												...
												<td>
													<button type="button" class="btn btn-outline-success radius-30" data-bs-toggle="modal" data-bs-target="#masterbookPageListModal">Buku Induk</button>
													@include('admin/page/masterbook/masterbook-page-list')
												</td>
												<td><input type="button" class="btn btn-danger" value="Blok Buku" /></td>
											</tr>
											<tr>
												<td>2</td>
												<td>510031750032 / 69985167</td>
											...
											<tr>
												...
												<td><input type="button" class="btn btn-secondary" value="Unblok Buku" /></td>
											</tr>
										</tbody>
									</table>
								</div>
