				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="container">
						<div class="main-body">
							<form method="post" action="{{ URL::to('/') }}/master-santri/{{ $santri['id'] }}" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
							@method('PUT')	
							@csrf
								<div class="row">
									<div class="col-lg-4">
										<div class="card">
											<div class="card-body">
												<div class="d-flex flex-column align-items-center text-center">
													<img src="{{ URL::to('/') }}/images/{{ $santri['photo'] }}" alt="Admin" class="rounded-circle p-1 bg-success" width="110" height="110">
													<div class="mt-3">
														<h5>Foto</h5>
											...
											<div class="card-body">
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inSantriNISM" type="number" id="inSantriNISM" class="form-control" value="{{ $santri['nism'] }}" />
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inSantriNISN" type="number" id="inSantriNISN" class="form-control" value="{{ $santri['nisn'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inSantriName" type="text" id="inSantriName" class="form-control" value="{{ $santri['name'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inSantriReligion" type="text" id="inSantriReligion" class="form-control" value="{{ $santri['agama'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inSantriHobi" type="text" id="inSantriHobi" class="form-control" value="{{ $santri['hobi'] }}"/>
													</div>
												</div>
												<div class="row mb-3 position-relative">
													<label for="inSantriCita" class="col-sm-3 col-form-label">Cita - Cita</label>
													<div class="col-sm-9 text-secondary">
														<input name="inSantriCita" type="text" id="inSantriCita" class="form-control" value="{{ $santri['cita_cita'] }}"/>
													</div>
												</div>
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<select class="form-select form-control" name="soSantriStatus" id="soSantriStatus" >
															<option value="{{ $santri['status_rumah'] }}" class="form-control">{{ $santri['status_rumah'] }}</option>	
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inSantriAnakKe" type="number" id="inSantriAnakKe" class="form-control" value="{{ $santri['anak_ke'] }}" />
													</div>
												</div>
												<div class="row mb-3">
													<label for="inSantriSchoolFrom" class="col-sm-3 col-form-label">Sekolah Asal</label>
													<div class="col-sm-9 text-secondary">
														<input name="inSantriSchoolFrom" type="text" id="inSantriSchoolFrom" class="form-control" value="{{ $santri['sekolah_asal'] }}" />
													</div>
												</div>
											</div>
										</div>
											...
											<div class="card-body">
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary" >
														...
														<option value="{{ $santri['kelas_id'] }}" class="form-control">{{ $santri['kelas'] }}</option>	
														@foreach ($kelass as $kelas)
															<option value="{{ $kelas['id'] }}">{{ $kelas['name'] }}</option>
														@endforeach
														</select>
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inAyahNoKK" type="number" id="inAyahNoKK" class="form-control" value="{{ $santri['no_kk'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inAyahNoNIK" type="number" id="inAyahNoNIK" class="form-control" value="{{ $santri['nik_ayah'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inAyahNama" type="text" id="inAyahNama" class="form-control" value="{{ $santri['nama_ayah'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soAyahJob" class="form-select form-control" id="soAyahJob">
															<option value="{{ $santri['pekerjaan_ayah'] }}">{{ $santri['pekerjaan_ayah'] }}</option>
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soAyahEducation" class="form-select form-control" id="soAyahEducation">
															<option value="{{ $santri['pendidikan_ayah'] }}">{{ $santri['pendidikan_ayah'] }}</option>
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inAyahPhone" type="text" id="inAyahPhone" class="form-control" value="{{ $santri['telepon_ayah'] }}" />
													</div>
												</div>
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soAyahSalery" class="form-select form-control" id="soAyahSalery">
															<option value="{{ $santri['gaji_ayah'] }}">{{ $santri['gaji_ayah'] }}</option>
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inIbuNoNIK" type="number" id="inIbuNoNIK" class="form-control" value="{{ $santri['nik_ibu'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inIbuNama" type="text" id="inIbuNama" class="form-control" value="{{ $santri['nama_ibu'] }}" required/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soIbuJob" class="form-select form-control" id="soIbuJob">
															<option value="{{ $santri['pekerjaan_ibu'] }}">{{ $santri['pekerjaan_ibu'] }}</option>
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soIbuEducation" class="form-select form-control" id="soIbuEducation">
															<option value="{{ $santri['pendidikan_ibu'] }}">{{ $santri['pendidikan_ibu'] }}</option>
															<option value="Tidak memiliki Pendidikan Formal">Tidak memiliki Pendidikan Formal</option>
															<option value="SD / MI Sederajat">SD / MI Sederajat</option>
															<option value="SMP / MTS Sederajat">SMP / MTS Sederajat</option>
															<option value="SMA / SMK / MA Sederajat">SMA / SMK / MA Sederajat</option>
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inIbuPhone" type="text" id="inIbuPhone" class="form-control" value="{{ $santri['telepon_ibu'] }}" />
													</div>
												</div>
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soIbuSalery" class="form-select form-control" id="soIbuSalery">
															<option value="{{ $santri['gaji_ibu'] }}">{{ $santri['gaji_ibu'] }}</option>
															<option value="Tidak Berpenghasilan Tetap">Tidak Berpenghasilan Tetap</option>
															<option value="< Rp. 500.000">< Rp. 500.000</option>
															<option value="Rp. 500.000 - Rp. 1.000.000">Rp. 500.000 - Rp. 1.000.000</option>
															<option value="Rp. 1.000.000 - Rp. 2.000.000">Rp. 1.000.000 - Rp. 2.000.000</option>
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inWaliNoKK" type="number" id="inWaliNoKK" class="form-control" value="{{ $santri['no_kk_wali'] }}"/>
													</div>
												</div>
												<div class="row mb-3 position-relative">
													<label for="inWaliNoNIK" class="col-sm-3 col-form-label">NIK Wali</label>
													<div class="col-sm-9 text-secondary">
														<input name="inWaliNoNIK" type="number" id="inWaliNoNIK" class="form-control" value="{{ $santri['nik_wali'] }}"/>
													</div>
												</div>
												<div class="row mb-3 position-relative">
													<label for="inWaliNama" class="col-sm-3 col-form-label">Nama Wali</label>
													<div class="col-sm-9 text-secondary">
														<input name="inWaliNama" type="text" id="inWaliNama" class="form-control" value="{{ $santri['nama_wali'] }}"/>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soWaliJob" class="form-select form-control" id="soWaliJob">
															<option value="{{ $santri['pekerjaan_wali'] }}">{{ $santri['pekerjaan_wali'] }}</option>
															<option value="Ibu Rumah Tangga">Ibu Rumah Tangga</option>
															<option value="Buruh (Tani / Pabrik / Bangunan)">Buruh (Tani / Pabrik / Bangunan)</option>
															<option value="Dokter / Bidan / Perawat">Dokter / Bidan / Perawat</option>
															<option value="Guru / Dosen">Guru / Dosen</option>
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soWaliEducation" class="form-select form-control" id="soWaliEducation">
															<option value="{{ $santri['pendidikan_wali'] }}">{{ $santri['pendidikan_wali'] }}</option>
															<option value="Tidak memiliki Pendidikan Formal">Tidak memiliki Pendidikan Formal</option>
															<option value="SD / MI Sederajat">SD / MI Sederajat</option>
															<option value="SMP / MTS Sederajat">SMP / MTS Sederajat</option>
															<option value="SMA / SMK / MA Sederajat">SMA / SMK / MA Sederajat</option>
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inWaliPhone" type="text" id="inWaliPhone" class="form-control" value="{{ $santri['telepon_wali'] }}" />
													</div>
												</div>
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soWaliSalery" class="form-select form-control" id="soWaliSalery">
															<option value="{{ $santri['gaji_wali'] }}">{{ $santri['gaji_wali'] }}</option>
															<option value="Tidak Berpenghasilan Tetap">Tidak Berpenghasilan Tetap</option>
															<option value="< Rp. 500.000">< Rp. 500.000</option>
															<option value="Rp. 500.000 - Rp. 1.000.000">Rp. 500.000 - Rp. 1.000.000</option>
															<option value="Rp. 1.000.000 - Rp. 2.000.000">Rp. 1.000.000 - Rp. 2.000.000</option>
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inAddress" type="text" id="inAddress" class="form-control" value="{{ $santri['alamat'] }}" />
													</div>
												</div>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-3 text-secondary">
														...
														<input name="soVillage" class="form-control" list="datalistOptions" id="soVillage" placeholder="Cari Desa / Kelurahan..." value="{{ $santri['desa'] }}" required>
													...
													<div class="col-sm-2 text-secondary">
														<input name="inRT" type="text" id="inRTRW" class="form-control" value="{{ substr($santri['rt_rw'], 0, 3) }}" />
													</div>
													<div class="col-sm-2 text-secondary">
														<input name="inRW" type="text" id="inSantriName" class="form-control" value="{{ substr($santri['rt_rw'], 4, 3) }}" />
													</div>
												</div>
												<div class="row mb-3">
													<label for="inDistrict" class="col-sm-3 col-form-label">Kecamatan</label>
													<div class="col-sm-3 text-secondary">
														<input name="inDistrict" type="text" id="inDistrict" class="form-control" value="{{ $santri['kecamatan'] }}" />
													</div>
													<label for="inKabOrCity" class="col-sm-2 col-form-label">Kab / Kota</label>
													<div class="col-sm-4 text-secondary">
														<input name="inKabOrCity" type="text" id="inKabOrCity" class="form-control" value="{{ $santri['kab_kota'] }}" />
													</div>
												</div>
												<div class="row mb-3">
													<label for="inProvince" class="col-sm-3 col-form-label">Provinsi</label>
													<div class="col-sm-3 text-secondary">
														<input name="inProvince" type="text" id="inProvince" class="form-control" value="{{ $santri['provinsi'] }}" />
													</div>
													<label for="inPosCode" class="col-sm-2 col-form-label">Kode Pos</label>
													<div class="col-sm-4 text-secondary">
														<input name="inPosCode" type="text" id="inPosCode" class="form-control" value="{{ $santri['kode_pos'] }}" />
													</div>
												</div>
												<div class="row mb-3">
