                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form method="post" action="{{ route('curriculum.store') }}"  enctype="multipart/form-data" onsubmit="return validateForm()">
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Ula/Curriculum" class="col-sm-12">
                                ...
                                <div class="input-group mb-3">
                                    <input name="inCurriculumUla" type="file" class="form-control" id="inCurriculumUla" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Ula/Silabus" class="col-sm-12">
                                ...
                                <div class="input-group mb-3">
                                    <input name="inSilabusUla" type="file" class="form-control" id="inSilabusUla" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Ula/RPP" class="col-sm-12">
                                ...
                                <div class="input-group mb-3">
                                    <input name="inRPPUla" type="file" class="form-control" id="inRPPUla" aria-describedby="inRPPUla" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Wustha/Curriculum" class="col-sm-12">
                                        <div class="card radius-10 bg-success">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <div class="widgets-icons rounded-circle mx-auto bg-white text-success mb-3"><i class='bx bx-download'></i>
                                ...
                                <div class="input-group mb-3">
                                    <input name="inCurriculumWustha" type="file" class="form-control" id="inCurriculumWustha" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Wustha/Silabus" class="col-sm-12">
                                        <div class="card radius-10 bg-warning">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <div class="widgets-icons rounded-circle mx-auto bg-white text-warning mb-3"><i class='bx bx-download'></i>
                                ...
                                <div class="input-group mb-3">
                                    <input name="inSilabusWustha" type="file" class="form-control" id="inSilabusWustha" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Wustha/RPP" class="col-sm-12">
                                        <div class="card radius-10 bg-info">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <div class="widgets-icons rounded-circle mx-auto bg-white text-info mb-3"><i class='bx bx-download'></i>
                                ...
                                <div class="input-group mb-3">
                                    <input name="inRPPWustha" type="file" class="form-control" id="inRPPWustha" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Ulya/Curriculum" class="col-sm-12">
                                        <div class="card radius-10 bg-success">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <div class="widgets-icons rounded-circle mx-auto bg-white text-success mb-3"><i class='bx bx-download'></i>
                                ...
                                <div class="input-group mb-3">
                                    <input name="inCurriculumUlya" type="file" class="form-control" id="inCurriculumUlya" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Ulya/Silabus" class="col-sm-12">
                                        <div class="card radius-10 bg-warning">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <div class="widgets-icons rounded-circle mx-auto bg-white text-warning mb-3"><i class='bx bx-download'></i>
                                ...
                                <div class="input-group mb-3">
                                    <input name="inSilabusUlya" type="file" class="form-control" id="inSilabusUlya" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="row">
                                    <a href="curriculum/Ulya/RPP" class="col-sm-12">
                                        <div class="card radius-10 bg-info">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <div class="widgets-icons rounded-circle mx-auto bg-white text-info mb-3"><i class='bx bx-download'></i>
                                ...
                                <div class="input-group mb-3">
                                    <input name="inRPPUlya" type="file" class="form-control" id="inRPPUlya" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                    <button class="btn btn-success" type="submit" id="inputGroupFileAddon04">Upload</button>
                                </div>
                                @endif
                            </form>
