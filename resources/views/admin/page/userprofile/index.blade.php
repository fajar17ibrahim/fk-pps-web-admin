				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="container">
						<div class="main-body">
							<form method="post" action="user-profile/{{ $ustadz[0]->ustadz_id }}" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
							@method('PUT')
							@csrf
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card">
											<div class="card-body">
												<div class="d-flex flex-column align-items-center text-center">
													<img src="images/{{ $ustadz[0]->ustadz_photo }}" alt="Admin" class="rounded-circle p-1 bg-success" width="110" height="110">
													<div class="mt-3">
														<h5>Foto</h5>
											...
											<div class="card-body">
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inUstadzNIK" type="text" id="inUstadzNIK" class="form-control" value="{{$ustadz[0]->ustadz_nik }}" required />
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inUstadzName" type="text" id="inUstadzName" class="form-control" value="{{$ustadz[0]->ustadz_name }}" required />
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzGender" class="form-select form-control" id="soUstadzGender" >
															<option value="{{$ustadz[0]->ustadz_gender }}" class="form-control">{{$ustadz[0]->ustadz_gender }}</option>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-3 text-secondary">
														<input name="inUstadzPlaceBorn" type="text" id="inUstadzPlaceBorn" class="form-control" value="{{$ustadz[0]->ustadz_born_place }}" required />
													...
													<div class="col-sm-4 text-secondary">
														<input name="inUstadzDateBorn" type="date" id="inUstadzDateBorn" class="form-control" value="{{$ustadz[0]->ustadz_born_date }}" required>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inUstadzReligion" type="text" id="inUstadzReligion" class="form-control" value="{{$ustadz[0]->ustadz_religion }}" required />
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inUstadzMotherName" type="text" id="inUstadzMotherName" class="form-control" value="{{$ustadz[0]->ustadz_mother_name }}" required />
														<div class="invalid-tooltip">Agama tidak boleh kosong</div>
													</div>
												</div>
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzProfesi" class="form-select form-control" id="soUstadzProfesi" >
															<option value="{{$ustadz[0]->ustadz_profesion }}" class="form-control">{{$ustadz[0]->ustadz_profesion }}</option>
												...
												<label for="soUstadzEmployeeStatus" class="col-sm-3 col-form-label">Status Pegawai</label>
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzEmployeeStatus" class="form-select form-control" id="soUstadzEmployeeStatus" >
															<option value="{{$ustadz[0]->ustadz_employee_status }}" class="form-control">{{$ustadz[0]->ustadz_employee_status }}</option>	
												...
												<label for="soUstadzTetap" class="col-sm-3 col-form-label">Tetap / Tidak</label>
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzTetap" class="form-select form-control" id="soUstadzTetap" >
															<option value="{{$ustadz[0]->ustadz_assigment_status }}" class="form-control">{{$ustadz[0]->ustadz_assigment_status }}</option>	
												...
												<label for="soUstadzEducation" class="col-sm-3 col-form-label">Pendidikan</label>
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzEducation" class="form-select form-control" id="soUstadzEducation" >
															<option value="{{$ustadz[0]->ustadz_education }}" class="form-control">{{$ustadz[0]->ustadz_education }}</option>	
												...
												<label for="soUstadzEducationIslamic" class="col-sm-3 col-form-label">Pendidikan Pesantren</label>
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzEducationIslamic" class="form-select form-control" id="soUstadzEducationIslamic" >
															<option value="{{$ustadz[0]->ustadz_education_pesantren }}" class="form-control">{{$ustadz[0]->ustadz_education_pesantren }}</option>
												...
												<label for="soUstadzEducationAbroad" class="col-sm-3 col-form-label">Pendidikan Luar Negeri</label>
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzEducationAbroad" class="form-select form-control" id="soUstadzEducationAbroad" >
															<option value="{{$ustadz[0]->ustadz_education_abroad }}" class="form-control">{{$ustadz[0]->ustadz_education_abroad }}</option>
															<option value="1 s/d 3 Tahun" class="form-control">1 s/d 3 Tahun</option>
															<option value="4 s/d 5 Tahun" class="form-control">4 s/d 5 Tahun</option>
															<option value="Tidak Pernah" class="form-control">Tidak Pernah</option>
														</select>
												...
												<label for="soUstadzCompetence" class="col-sm-3 col-form-label">Kompetensi</label>
													<div class="col-sm-9 text-secondary">
														<select name="soUstadzCompetence" class="form-select form-control" id="soUstadzCompetence" >
															<option value="{{$ustadz[0]->ustadz_competence }}" class="form-control">{{$ustadz[0]->ustadz_competence }}</option>
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inUstadzEmail" type="text" id="inUstadzEmail" class="form-control" value="{{$ustadz[0]->ustadz_email }}" required />
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inUstadzPhone" type="text" id="inUstadzPhone" class="form-control" value="{{$ustadz[0]->ustadz_phone }}" required />
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-9 text-secondary">
														<input name="inAddress" type="text" id="inAddress" class="form-control" value="{{$ustadz[0]->ustadz_address }}" />
													</div>
												</div>
												<div class="row mb-3 position-relative">
													...
													<div class="col-sm-3 text-secondary">
														...
														<input name="soVillage" class="form-control" list="datalistOptions" id="soVillage" placeholder="Cari Desa / Kelurahan..." value="{{$ustadz[0]->ustadz_village }}" required>
													...
													<div class="col-sm-2 text-secondary">
														<input name="inRT" type="text" id="inRT" class="form-control" placeholder="001" value="{{ substr($ustadz[0]->ustadz_rt_rw, 0, 3) }}" />
													</div>
													<div class="col-sm-2 text-secondary">
														<input name="inRW" type="text" id="inRW" class="form-control" placeholder="001" value="{{ substr($ustadz[0]->ustadz_rt_rw, 4, 3) }}" />
													</div>
												</div>
												<div class="row mb-3 position-relative">
													<label for="inDistricts" class="col-sm-3 col-form-label">Kecamatan</label>
													<div class="col-sm-3 text-secondary">
														<input name="inDistricts" type="text" id="inDistricts" class="form-control" value="{{$ustadz[0]->ustadz_districts }}" />
													</div>
													<label for="inKabOrCity" class="col-sm-2 col-form-label">Kab / Kota</label>
													<div class="col-sm-4 text-secondary">
														<input name="inKabOrCity" type="text" id="inKabOrCity" class="form-control" value="{{$ustadz[0]->ustadz_city }}" />
													</div>
												</div>
												<div class="row mb-3 position-relative">
													<label for="inProvince" class="col-sm-3 col-form-label">Provinsi</label>
													<div class="col-sm-3 text-secondary">
														<input name="inProvince" type="text" id="inProvince" class="form-control" value="{{$ustadz[0]->ustadz_province }}" />
													</div>
													<label for="inPosCode" class="col-sm-2 col-form-label">Kode Pos</label>
													<div class="col-sm-4 text-secondary">
														<input name="inPosCode" type="text" id="inPosCode" class="form-control" value="{{$ustadz[0]->ustadz_pos_code }}" />
													</div>
												</div>
												<div class="row mb-3 position-relative">
