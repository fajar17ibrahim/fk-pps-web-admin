...
class AdminReportValueController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user['akses'] == 1) {
            ...
            $mapelsData = MapelTeacher::leftJoin('mapel', 'mapel_teacher.mapel_id', '=', 'mapel.mapel_id')
                    ->leftJoin('kelas','kelas.class_id','=','mapel_teacher.class_id')          
                    ->where('kelas.class_school', '=', $user['sekolah'])    
                    ->where('mapel_teacher.class_id', '=', $user['kelas'])       
                    ->orderBy('mapel_name', 'asc')->get();
    ...
    public function listData($level, $school, $kelas, $mapel) {
        ...
        foreach ($santris as $santri) {
            ...
            $row[] = '<input id="inP1' .$index .'" name="inP1[]" type="number" style="width:80px;" class="form-control" value="'. $p1 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP2' .$index .'" name="inP2[]" type="number" style="width:80px;" class="form-control" value="'. $p2 . '" onchange="calculate('. $index . ')"/>';
            $row[] = '<input id="inP3' .$index .'" name="inP3[]" type="number" style="width:80px;" class="form-control" value="'. $p3 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP4' .$index .'" name="inP4[]" type="number" style="width:80px;" class="form-control" value="'. $p4 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP5' .$index .'" name="inP5[]" type="number" style="width:80px;" class="form-control" value="'. $p5 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP6' .$index .'" name="inP6[]" type="number" style="width:80px;" class="form-control" value="'. $p6 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP7' .$index .'" name="inP7[]" type="number" style="width:80px;" class="form-control" value="'. $p7 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP8' .$index .'" name="inP8[]" type="number" style="width:80px;" class="form-control" value="'. $p8 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP9' .$index .'" name="inP9[]" type="number" style="width:80px;" class="form-control" value="'. $p9 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inP10' .$index .'" name="inP10[]" type="number" style="width:80px;" class="form-control" value="'. $p10 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inRPH' .$index .'" name="inRPH[]" type="number" style="width:80px;" class="form-control" value="'. $rph . '" onchange="calculate('. $index . ')" readonly  />';
            $row[] = '<input id="inPTS' .$index .'" name="inPTS[]" type="number" style="width:80px;" class="form-control" value="'. $pts . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inPAS' .$index .'" name="inPAS[]" type="number" style="width:80px;" class="form-control" value="'. $pas . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inHPA' .$index .'" name="inHPA[]" type="number" style="width:80px;" class="form-control" value="'. $hpa . '" readonly />';
            $row[] = '<input id="inPPRE' .$index .'" name="inPPRE[]" type="text" class="form-control" value="'. $ppre . '" readonly />';
            $row[] = '<textarea id="taDailyDesc' .$index .'" name="taDailyDesc[]" style="width:300px; height:100px" class="form-control" id="inputDescription" placeholder="" rows="3" readonly>'. $pdesc . '</textarea>';
            $row[] = '<input id="inK1' .$index .'" name="inK1[]" type="number" style="width:80px;" class="form-control" value="'. $k1 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK2' .$index .'"  name="inK2[]" type="number" style="width:80px;" class="form-control" value="'. $k2 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK3' .$index .'" name="inK3[]" type="number" style="width:80px;" class="form-control" value="'. $k3 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK4' .$index .'" name="inK4[]" type="number" style="width:80px;" class="form-control" value="'. $k4 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK5' .$index .'" name="inK5[]" type="number" style="width:80px;" class="form-control" value="'. $k5 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK6' .$index .'" name="inK6[]" type="number" style="width:80px;" class="form-control" value="'. $k6 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK7' .$index .'" name="inK7[]" type="number" style="width:80px;" class="form-control" value="'. $k7 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK8' .$index .'" name="inK8[]" type="number" style="width:80px;" class="form-control" value="'. $k8 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK9' .$index .'" name="inK9[]" type="number" style="width:80px;" class="form-control" value="'. $k9 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inK10' .$index .'" name="inK10[]" type="number" style="width:80px;" class="form-control" value="'. $k10 . '" onchange="calculate('. $index . ')" />';
            $row[] = '<input id="inRPK' .$index .'" name="inRPK[]" type="number" style="width:80px;" class="form-control" value="'. $rpk . '" onchange="calculate('. $index . ')" readonly  />';
            $row[] = '<input id="inKPRE' .$index .'" name="inKPRE[]" type="text" style="width:80px;" class="form-control" value="'. $kpre . '" onchange="calculate('. $index . ')" readonly />';
            $row[] = '<textarea id="taSkillsDesc' .$index .'" name="taSkillsDesc[]" style="width:300px; height:100px" class="form-control" id="inputDescription" placeholder="" rows="3" readonly>'. $kdesc . '</textarea>';
            $data[] = $row;
        }
