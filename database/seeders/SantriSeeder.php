...
class SantriSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $santri = new Santri;
        $santri->santri_name = 'Alice';
        $santri->santri_nism = '1234567891';
        $santri->santri_nisn = '0987654322';
        $santri->santri_gender = 'Laki-Laki';
        $santri->santri_born_place = 'Surabaya';
        $santri->santri_born_date = '2004-01-02';
        $santri->santri_religion = 'Islam';
        $santri->santri_hobby = 'Membaca';
        $santri->santri_goal = 'Dai';
        $santri->santri_home_status = 'Rumah Ayah';
        ...
        $santri = new Santri;
        $santri->santri_name = 'Ella';
        $santri->santri_nism = '1234567892';
        $santri->santri_nisn = '0987654323';
        $santri->santri_gender = 'Laki-Laki';
        $santri->santri_born_place = 'Surabaya';
        $santri->santri_born_date = '2004-01-02';
        $santri->santri_religion = 'Islam';
